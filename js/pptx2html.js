$(document).ready(function() {
	...
	if (window.Worker) {
        ...
        $("#download-reveal-btn").click(function() {
            if (!isDone) { return; }
            var prefix = "<html lang=\"zh-TW\">\n"
                + "<head>\n"
                + "<meta charset=\"utf-8\">\n"
                + "<title>Demo</title>\n"
                + "<link rel=\"stylesheet\" href=\"css/reveal.css\">\n"
                + "<link rel=\"stylesheet\" href=\"css/theme/pptx.css\" id=\"theme\">  \n"
                + "\n"
                ...
                + "\n"
                + "\t<div class=\"reveal\">\n"
                + "\t\t<div id=\"target\" class=\"slides\">";
            var slides = $result.html();
            var suffix = "</div>\n"
                + "\t</div>\n"
                + "\n"
